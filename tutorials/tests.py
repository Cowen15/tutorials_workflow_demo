...
def new_tutorial(db):
    tutorial = Tutorial.objects.create(
        title = 'Pytest',
        tutorial_url = 'https://pytest-django.readthedocs.io/en/lates/index.html', 
        description = 'Tutorial on how to apply pytest to a Django application',
        published = True,
    )
    return tutorial
...
def test_update_tutoril(new_tutorial):
...
def another_tutorial(db):
    tutorial = Tutorial.objects.create(
        title = 'More-Pytest',
        tutorial_url = 'https://pytest-django.readthedocs.io/en/lates/index.html',
        description = 'Tutorial on how to apple pytest to a Django application',
        published = True,
    )
    return tutorial
